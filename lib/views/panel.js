...
var prepareDom = function (el) {
  el
    .addClass('git-replay padded')
    .append(templates.panels.branches())
    .append(templates.panels.tags())
    .append(templates.panels.commits());
};

var GitReplayView = function (serializedState) { // eslint-disable-line no-unused-vars
...
GitReplayView.prototype.serialize = function () {
};

GitReplayView.prototype.destroy = function () {
  this.subscriptions.dispose();
  this.element.remove();
};

GitReplayView.prototype.getElement = function () {
  return this.element;
};

GitReplayView.prototype.updateElement = function (type, items) {
  var self = this;
